...
export default function DashboardPage() {
  ...
  // * custom hooks
  const { takeAttendance, presences } = useTakeAttendance();
    ...
    <>
      {authUser.type === UserType.STUDENT ? (
        <div className="h-full flex flex-col">
          <h1 className="text-2xl font-bold px-5 py-5">Student Dashboard</h1>
        ...
        <div className="flex flex-col min-h-full lg:h-full py-2">
          <h1 className="title_h1 px-5 py-1">Teacher Dashboard</h1>
