...
export const AssignmentsPage = () => {
  ...
  // * hardcoded vars
  const isPrevBtnDisabled = assignments && assignments.current_page <= 1;
      ...
      <div className="px-5 py-2 lg:w-4/5 mx-auto">
        ...
        <div className="flex justify-center gap-4 mt-4">
          <button
            ...
            className={`${
              isPrevBtnDisabled && "!cursor-not-allowed opacity-50"
            } btn-pretty`}
          >
            previous page
          </button>
          <button
            ...
            className={`${
              isNextBtnDisabled && "!cursor-not-allowed opacity-50"
            } btn-pretty`}
          >
            next page
          </button>
