      ...
      <div className="md:h-2/3 lg:h-auto overflow-hidden flex max-md:flex-col gap-6 max-lg:grow">
        <div className="md:w-1/2 lg:w-7/12 h-full">
          <div className="gap-2 mb-4 flex flex-wrap">
            {navLinks(Number(id)).map(({ label, to, className }) => (
        ...
        {Array.from({ length: 10 }).map((_, i) => (
          ...
          >
            ...
            <div className="col-span-2 border-x line-clamp-3">
              ...
              recusandae esse debitis illo perferendis quibusdam maiores ex
              molestiae aliquam aliquid!
            </div>
            <div className="flex justify-center items-center ">Pincopallo</div>
          </div>
        ))}
      </div>
    </>
