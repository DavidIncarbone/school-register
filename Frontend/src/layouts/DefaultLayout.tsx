...
export default function DefaultLayout() {
  ...
  useEffect(() => {
    ...
    // Gestisco l'unmount del componente pulendo gli event listener ed usando il metodo di lodash "cancel()" per interrompere eventuali operazioni messe in attesa dal throttle
    return () => {
